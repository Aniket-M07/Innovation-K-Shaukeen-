...
A Flask-based campus portal that combines secure authentication, searchable campus documents, faculty lookup, notices, notifications, and profile management.
...
- Smart search with automatic keyword, prefix, and filename matching plus category filtering
...
- Sample in-memory data for faculty, notices, and notifications
- All web routes
...
| `/search` | GET | Search documents (smart ranking + category) |
...
- Smart ranking combines:
  - keyword relevance
  - prefix relevance via trie
  - filename contains/prefix relevance
